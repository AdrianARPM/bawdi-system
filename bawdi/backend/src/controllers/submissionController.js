   ...
   const { status, type, q, belum_bayar, belum_nota, page = 1, limit = 20 } = req.query;
    ...
    let query = supabase
      ...
      .select(`
        ...
        nota_url, approval_at, ditunda_sampai,
...
async function create(req, res) {
  try {
    const {
      ...
      vendor2, npwp2, rekening_tujuan2, jenis_pembelian, alasan, alasan_type, riwayat, riwayat2,
    ...
    const { error: subErr } = await supabase.from('submissions').insert({
      ...
      jenis_pembelian, alasan, alasan_type: alasan_type || '', riwayat, riwayat2: riwayat2 || '',
